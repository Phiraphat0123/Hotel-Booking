...
export default function StarList ({star}){
    ...
    useEffect(()=>{
        ...
        const getStar=(num)=>{
            let list =[]
            for(let i =0;i<num;i++){
                list.push(<svg  width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            // style={{width:`${size}px`,height:`${size}px`,gap:`${gapSize}px`}}
            if((5-num)==0){
                return list
            }else{
