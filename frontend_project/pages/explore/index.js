...
export default function Explore (){
    ...
    // const [adultAmountValue,setAdultAmountValue]=useState(0)
    // const [childrenAmountValue,setChildrenAmountValue]=useState(0)
    // const [roomAmountValue,setRoomAmountValue]=useState(0)
    const {
    ...
    const inputAdult =(event)=>{
        setAdultAmount(event.target.value)
    }
    const inputChildren=(event)=>{
        setChildrenAmount(event.target.value)
    }
    const inputRoom=(event)=>{
        setRoomAmount(event.target.value)
    }
    const searchClick=()=>{
        router.push('/explore/hotels')
    }
    return (
